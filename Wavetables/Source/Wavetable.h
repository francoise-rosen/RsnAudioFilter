...
class WavetableOscillator_V2 {
public:
    WavetableOscillator_V2 (const AudioSampleBuffer& wavetableToUse, Phasor* phase)
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(WavetableOscillator_V2);
};
